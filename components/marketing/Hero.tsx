  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-b from-white to-gray-50 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 lg:pt-20 pb-6 sm:pb-10 lg:pb-16 relative z-10">
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center justify-between">
            {/* Left Content */}
            <div className="text-center lg:text-left space-y-3 sm:space-y-5 lg:space-y-8 animate-fadeInUp flex-1">
              {/* Badge */}
              <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4 py-1 sm:py-2 bg-primary/10 rounded-full text-primary font-medium text-[10px] sm:text-sm">
                <Zap className="w-2.5 h-2.5 sm:w-4 sm:h-4" />
              ...
              {/* Description */}
              <p className="text-xs sm:text-base lg:text-xl text-gray-600 leading-relaxed mx-auto lg:mx-0 max-w-lg">
              ...
              <div className="hidden sm:flex flex-col gap-3 max-w-xl mx-auto lg:mx-0">
                <div className="flex items-center gap-3 text-gray-700">
                  <div className="w-5 h-5 rounded-full bg-primary flex items-center justify-center flex-shrink-0">
                    <Check className="w-3 h-3 text-white stroke-[3]" />
                  </div>
                  <span className="text-sm lg:text-lg">100% gratuit pour les clients, sans publicité</span>
                </div>
                <div className="flex items-center gap-3 text-gray-700">
                  <div className="w-5 h-5 rounded-full bg-primary flex items-center justify-center flex-shrink-0">
                    <Check className="w-3 h-3 text-white stroke-[3]" />
                  </div>
                  <span className="text-sm lg:text-lg">Scan NFC & QR code ultra-rapide</span>
                </div>
                <div className="flex items-center gap-3 text-gray-700">
                  <div className="w-5 h-5 rounded-full bg-primary flex items-center justify-center flex-shrink-0">
                    <Check className="w-3 h-3 text-white stroke-[3]" />
                  </div>
                  <span className="text-sm lg:text-lg">Programme de fidélité personnalisable</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-center lg:justify-start pt-1 sm:pt-4">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-1.5 sm:gap-3 px-3 sm:px-6 lg:px-8 py-2 sm:py-3.5 lg:py-4 bg-white text-primary border-2 border-primary rounded-lg sm:rounded-2xl font-semibold text-[11px] sm:text-base hover:bg-secondary hover:text-white hover:border-secondary hover:shadow-2xl hover:scale-105 transition-all duration-300"
                >
                  ...
                  <span>Télécharger sur Apple Store</span>
                </a>
                <a
